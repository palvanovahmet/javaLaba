...
public class MainFrame extends JFrame {
	...
	Action showReferenceAction= new AbstractAction("") {
		public void actionPerformed(ActionEvent event) {
			JOptionPane.showMessageDialog(MainFrame.this, "Программу написал Мырадов.O 2-курс, 6-группа");	
...
"Поиск значения", JOptionPane.QUESTION_MESSAGE); 
 	 	...
 	 	JLabel labelForFrom = new JLabel("Xизменяется на интервале от:"); 
 	 	...
 	 	buttonCalc.addActionListener(new ActionListener() { 
 	 	 	public void actionPerformed(ActionEvent ev) { 
 	 	 	 	try { 
 	 	 	 	 	...
 	 	 	 	 	for(int i=0;i<3;i++)
 	 	 	 	 	table.getColumnModel().getColumn(i).setHeaderValue(data.getColumName(i));
